...
void Bucket::elements()
{

    int large1 = std::distance(largeBucketStartS1,largeBucketEndS1);
    int large2 = std::distance(largeBucketStartS2,largeBucketEndS2);

    int b1 = std::distance(startS1,endS1);
    int b2 = std::distance(startS2,endS2);

    int large2Rev = std::distance(largeBucketStartS2Rev,largeBucketEndS2Rev);
    int b2Rev = std::distance(startS2Rev,endS2Rev);

std::cout << "L1:" << large1 << "L2:" << large2 << "b1:"<< b1 << "b2:" << b2 << "large2Rev:" << large2Rev << "b2Rev:"<< b2Rev;
